...
<html>
    ...
    <body onload="getDate()">
        ...
        <form action="success.jsp" method="post" id="form1">
            ...
            <input type="date" name="date" id="date1" style="margin-right: 40px"/><input type="button"class="btn btn-success" style="background: #3e3d3d;color:white" value="Fetch" onclick="fetch()"/>
            <div id="d">
            </div>
