...
<%
    ...
    if (rs.next()) {
        String security_ques = rs.getString("security_question");
%>
<form class="form-horizontal" method="post" action="fetchpassword.jsp">
    ...
    <div class="form-group">
        <center><input type="submit" value="Continue" class="btn btn-success" style="background: #3e3d3d;color:white;margin-right:650px"/></center>
    </div>
