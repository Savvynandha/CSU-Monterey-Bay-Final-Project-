    ...
    <div class="top-nav">
        <div class="container">
            <div class="navbar-header logo">
                ...
                <div>
                    <%--<img src="../images/banner.jpg" width="1000" height="200" alt="logo" /> --%>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-right" style="position: relative">
                    ...
                    <li><a href="categories.jsp" class="scroll"><span data-hover="About">Categories</span></a></li>
                    ...
                    <li>
                         <input type="text" class="form-control" name="search" placeholder="Service providers" onkeyup="fetch_search(this.value)"/>
