        ...
        <script>
            ...
            function initialize()
            {
                ...
                var defaultBounds = new google.maps.LatLngBounds(
                        new google.maps.LatLng(37.757815, -122.5076401),
                        new google.maps.LatLng(37.2972061, -121.9574979));
    ...
    <%@include file="public_header.jsp"%>
        ...
        <div class="container" style="min-height: 523px">
            ...
            <form  action="./MultiFileUploader5" class="form-horizontal" method="post" enctype="multipart/form-data"><br>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                     <label class="col-sm-2">Select County</label>
        ...
        <div id="map1" style="width: 1000px; height: 600px;">
              ...
              <input type="text" name="long" id="lng1">
                    ...
                    <center>  <input type="submit" class="btn btn-success" value="SIGN UP"  style="background: #3e3d3d;color:white;margin-top:10px"/></center>
