...
--%>
        <div class="row">
            ...
            <div align="center">
            <div class="col-sm-7" style="border: solid 1px black ;background-color:lightgray; padding: 5px" id="maindiv"  align-items:center>
                <div  style="border-bottom: solid 1px black;margin-bottom: 20px"  >
                    ...
                    %>
                    <div  style="background: #3e3d3d" ><label style="font-family:roboto;padding: 10px;font-size: 25px;color:white"><b><%=c_name%></b></label></div>
                ...
                <% Class.forName("com.mysql.jdbc.Driver");
                    ...
                    ResultSet rs = stmt.executeQuery("select * from sub_categories where category_name=\'" + c_name + "\'");
                    while (rs.next()) {
                        String photo = rs.getString("photo");
                        String sub_cat = rs.getString("sub_category_name");
                ...
                <div class="col-sm-4">
                    <div>
                        ...
                        <label style="font-family: roboto;color: brown"><%=sub_cat%></label><br>
                    <input type="button" value="Explore" name="ex" data-toggle="modal" class="btn btn-success" onclick="go2('<%=sub_cat%>')" style="background: #3e3d3d;color:white"/>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content" style="background-color: white">
                    <div class="modal-header">
                        ...
                        <center><label style="font-family: roboto;color: black">Sub Category Description</label><br></center>
