...
<%}
    ...
    <div class="container-fluid"  style="min-height: 523px;padding: 0px">
            ...
            <%  Class.forName("com.mysql.jdbc.Driver");
                ...
                ResultSet rs3 = stmt3.executeQuery("select * from sub_categories where sub_category_name=\'" + sub_category + "\'");
            ...
            <center> <div class="lead"><label>There are a total of: <%= c1%> service provider(s) under <%=sub_category%> </label></div><br></center>
               
                <a href="index.jsp" style="font-size: 25px" ><button class="btn btn-success" style="background: #3e3d3d;color:white"><%=cat%></button></a><div class="glyphicon glyphicon-chevron-right"></div>
                <a href="home_subcat_forcat.jsp?name=<%=cat%>" style="font-size: 25px"><button class="btn btn-success" style="background: #3e3d3d;color:white"><%=sub_category%></button></a><div class="glyphicon glyphicon-chevron-right"></div>
                <label style="font-size: 25px">Service Providers</label>
             <div style="margin-left:1000px">   Filter by city <select name="city" onchange="city(this.value)">
            ...
            <div class="col-sm-3" style="border: solid 2px black; margin-left: 10px">
                        ...
                        <label style="font-size: 20px; font-style: roboto; font-family: roboto"><%=name%></label><br>
                        <img src="<%=photo_sp%>" style="width: 220px;height: 200px"/><br>
                        <label style="font-size: 15px">Rate per hour: <%=price%></label><br>
                        <a href="service_provider_detail.jsp?sp_email=<%=sp_email%>"> <input type="button" class="btn btn-success" style="float: right; background: #cc9900; color: white;background: #3e3d3d;color:white"  value="Book"/>
                        </a>
                </div>
                <%
                    }
