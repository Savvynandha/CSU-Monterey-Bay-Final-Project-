...
<html>
    ...
    <body  onload="go()" style="background-color:#f5f5f5">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2" style="background: grey; padding: 20px;margin-top: 10px">
                    <form action="edit_service_provider.jsp">
                        ...
                        <div class="form-group"> 
                            <label class="col-sm-2">Email</label>
                               <div class="col-sm-10"><label><%= sp_email%></label></div> 
                        </div>
                        
                            <input type="hidden" value="<%= sp_email%>" name="sp_email"/> 
                        ...
                        <div class="form-group"> <label class="col-sm-2">Website</label>
                            <div class="col-sm-10"><label><%= website%></label>
                            </div>
                        </div>
                        ...
                        <input type="hidden" value="<%=sub_category%>" name="sub_category"/>
                        <div class="col-sm-offset-11"><input type="submit" class="btn btn-success" value="Edit" style="background: #3e3d3d;color:white" /></div>
                    </form>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-sm-8 col-sm-offset-2" style="background: white; padding: 20px; margin-top: 10px; ">
                    <div class="row" > <label class="col-sm-2">Work Gallery</label>
                        <button class="btn btn-success"   data-toggle="modal" data-target="#add_photo" style="float:right;background: #3e3d3d;color:white"><span class="glyphicon glyphicon-plus-sign">Add Photos</span></button>
                    ...
                    <div class="row" style="height: 300px;overflow: auto; padding: 10px">
                        ...
                        <%
                            ...
                            while (rs1.next()) {
                                ...
                                String id = rs1.getString("galley_id");
                        %>
                    ...
                    <div class="modal-content" style="background-color: white">
                        ...
                        <div class="modal-body">
                            <form action="./MultiFileUploader6" method="post" enctype="multipart/form-data">
                                ...
                                <center>  <input type="submit" value="Add" class="btn btn-success" style="background: #3e3d3d;color:white;margin-top: 10px"/></center>
