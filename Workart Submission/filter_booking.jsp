...
<div class="container">
    ...
    <div id="booking">
        ...
        <div class="form-group"> <label  style="margin-left:700px"> Filter According To Date</label><input type="date" name="date"/>
            <input type="button" value="Filter" class="btn btn-success" style="background: #3e3d3d;color:white" onclick="filter()"/>   </div>
    ...
    <%            String sp_email = session.getAttribute("sp_email").toString();
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <td>
                    <input type="button" class="btn-success" value="Delete" onclick="cancel('<%=b_id%>','<%=date1%>')" style="background: #3e3d3d;color:white"/>
                </td>
